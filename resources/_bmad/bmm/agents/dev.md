...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="DS or fuzzy match on dev-story" workflow="{bmad-path}/bmm/workflows/4-implementation/dev-story/workflow.yaml">[DS] Dev Story: Write the next or specified stories tests and code.</item>
