...
- Example: If `stepsCompleted: [1, 2, 3]`, load `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md`
...
- If confirmed: Delete existing document and read fully and follow: `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-01-init.md`
...
- `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-02-context.md`
- `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-03-starter.md`
- `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md`
- `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-05-patterns.md`
- `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-06-structure.md`
- `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-07-validation.md`
- `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-08-complete.md`
