...
- Read fully and follow: {bmad-path}/core/workflows/advanced-elicitation/workflow.xml with the current context analysis
...
- Read fully and follow: {bmad-path}/core/workflows/party-mode/workflow.md with the current project context
...
- Load `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-03-starter.md`
...
After user selects 'C' and content is saved to document, load `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-03-starter.md` to evaluate starter template options.
