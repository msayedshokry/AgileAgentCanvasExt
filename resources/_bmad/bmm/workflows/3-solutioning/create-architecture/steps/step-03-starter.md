...
- Read fully and follow: {bmad-path}/core/workflows/advanced-elicitation/workflow.xml with current starter analysis
...
- Read fully and follow: {bmad-path}/core/workflows/party-mode/workflow.md with starter evaluation context
...
- Load `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md`
...
After user selects 'C' and content is saved to document, load `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-04-decisions.md` to begin making specific architectural decisions.
