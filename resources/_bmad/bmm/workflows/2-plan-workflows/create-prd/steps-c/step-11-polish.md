...
# File References
nextStepFile: '{bmad-path}/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-12-complete.md'
outputFile: '{planning_artifacts}/prd.md'
purposeFile: '{bmad-path}/bmm/workflows/2-plan-workflows/create-prd/data/prd-purpose.md'
...
After user selects 'C' and polished document is saved, load `{bmad-path}/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-12-complete.md` to complete the workflow.
