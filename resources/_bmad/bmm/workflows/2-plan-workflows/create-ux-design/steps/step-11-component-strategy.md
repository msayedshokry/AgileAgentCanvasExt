...
- Read fully and follow: {bmad-path}/core/workflows/advanced-elicitation/workflow.xml with the current component strategy content
...
- Read fully and follow: {bmad-path}/core/workflows/party-mode/workflow.md with the current component strategy
...
- Load `{bmad-path}/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-12-ux-patterns.md`
...
After user selects 'C' and content is saved to document, load `{bmad-path}/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-12-ux-patterns.md` to define UX consistency patterns.
