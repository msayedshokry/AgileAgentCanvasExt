...
- Read fully and follow: {bmad-path}/core/workflows/advanced-elicitation/workflow.xml with the current core experience content
...
- Read fully and follow: {bmad-path}/core/workflows/party-mode/workflow.md with the current core experience definition
...
- Load `{bmad-path}/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-04-emotional-response.md`
...
After user selects 'C' and content is saved to document, load `{bmad-path}/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-04-emotional-response.md` to define desired emotional responses.
