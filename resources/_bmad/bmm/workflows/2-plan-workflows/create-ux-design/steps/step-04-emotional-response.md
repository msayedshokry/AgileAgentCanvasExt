...
- Read fully and follow: {bmad-path}/core/workflows/advanced-elicitation/workflow.xml with the current emotional response content
...
- Read fully and follow: {bmad-path}/core/workflows/party-mode/workflow.md with the current emotional response definition
...
- Load `{bmad-path}/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-05-inspiration.md`
...
After user selects 'C' and content is saved to document, load `{bmad-path}/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-05-inspiration.md` to analyze UX patterns from inspiring products.
