...
- **STOP here** and load `{bmad-path}/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-01b-continue.md` immediately
...
After user selects [C] to continue, ensure the file `{planning_artifacts}/ux-design-specification.md` has been created and saved, and then load `{bmad-path}/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-02-discovery.md` to begin the UX discovery phase.
