...
# File References
nextStepFile: '{bmad-path}/bmm/workflows/1-analysis/create-product-brief/steps/step-02-vision.md'
...
- **STOP immediately** and load `{bmad-path}/bmm/workflows/1-analysis/create-product-brief/steps/step-01b-continue.md`
