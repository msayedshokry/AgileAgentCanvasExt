...
- If `lastStep = 1` → Load `{bmad-path}/bmm/workflows/1-analysis/create-product-brief/steps/step-02-vision.md`
- If `lastStep = 2` → Load `{bmad-path}/bmm/workflows/1-analysis/create-product-brief/steps/step-03-users.md`
- If `lastStep = 3` → Load `{bmad-path}/bmm/workflows/1-analysis/create-product-brief/steps/step-04-metrics.md`
