...
- Load: `{bmad-path}/bmm/workflows/1-analysis/research/domain-steps/step-02-domain-analysis.md`
...
After user selects 'C', load `{bmad-path}/bmm/workflows/1-analysis/research/domain-steps/step-02-domain-analysis.md` to begin industry analysis.
