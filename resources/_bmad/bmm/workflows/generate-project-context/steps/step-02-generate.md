...
- When 'A' selected: Execute {bmad-path}/core/workflows/advanced-elicitation/workflow.xml
- When 'P' selected: Execute {bmad-path}/core/workflows/party-mode
...
After completing all rule categories and user selects 'C' for the final category, load `{bmad-path}/bmm/workflows/generate-project-context/steps/step-03-complete.md` to finalize the project context file.
