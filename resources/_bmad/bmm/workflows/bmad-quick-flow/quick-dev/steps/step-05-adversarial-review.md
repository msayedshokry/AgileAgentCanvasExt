...
```xml
<invoke-task>Review {diff_output} using {bmad-path}/core/tasks/review-adversarial-general.xml</invoke-task>
```
...
With findings in hand, read fully and follow: `{bmad-path}/bmm/workflows/bmad-quick-flow/quick-dev/steps/step-06-resolve-findings.md` for user to choose resolution approach.
