...
- **NEXT:** Read fully and follow: `{bmad-path}/bmm/workflows/bmad-quick-flow/quick-dev/steps/step-03-execute.md`
...
- IF E: Ask for any additional guidance, then **NEXT:** Read fully and follow: `{bmad-path}/bmm/workflows/bmad-quick-flow/quick-dev/steps/step-02-context-gathering.md`
...
- IF E: Ask for guidance, then **NEXT:** Read fully and follow: `{bmad-path}/bmm/workflows/bmad-quick-flow/quick-dev/steps/step-02-context-gathering.md`
...
- Mode A (tech-spec): "**NEXT:** read fully and follow: `{bmad-path}/bmm/workflows/bmad-quick-flow/quick-dev/steps/step-03-execute.md`"
- Mode B (direct, [E] selected): "**NEXT:** Read fully and follow: `{bmad-path}/bmm/workflows/bmad-quick-flow/quick-dev/steps/step-02-context-gathering.md`"
