...
- trigger: CP or fuzzy match on create-prd
  exec: '{bmad-path}/bmm/workflows/create-prd/workflow.md'
...
- trigger: TS or fuzzy match on team-standup
  exec: '{bmad-path}/bmm/tasks/team-standup.md'
  data: '{bmad-path}/_config/agent-manifest.csv'
...
```yaml
# ✅ CORRECT
exec: '{bmad-path}/core/workflows/brainstorming/workflow.md'
...
menu:
  ...
  - trigger: SM or fuzzy match on save-memory
    action: 'Update {bmad-path}/_memory/journal-keeper-sidecar/memories.md'
...
menu:
  - trigger: WI or fuzzy match on workflow-init
    exec: '{bmad-path}/bmm/workflows/workflow-status/workflow.md'
...
7. **Sidecar paths:** `{bmad-path}/_memory/{sidecar-folder}/`
