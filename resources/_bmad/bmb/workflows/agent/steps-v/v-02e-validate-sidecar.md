...
- [ ] Verify path format is correct: `{bmad-path}/_memory/{sidecar-folder}/...`
...
- [ ] Loads sidecar memories: `{bmad-path}/_memory/{sidecar-folder}/memories.md`
- [ ] Loads sidecar instructions: `{bmad-path}/_memory/{sidecar-folder}/instructions.md`
- [ ] Restricts file access: `ONLY read/write files in {bmad-path}/_memory/{sidecar-folder}/`
...
- [ ] Sidecar path format correct: `{bmad-path}/_memory/{sidecar-folder}/...`
