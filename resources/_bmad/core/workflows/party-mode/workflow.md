...
Load config from `{bmad-path}/core/config.yaml` and resolve:

- `project_name`, `output_folder`, `user_name`
- `communication_language`, `document_output_language`, `user_skill_level`
- `date` as a system-generated value
- Agent manifest path: `{bmad-path}/_config/agent-manifest.csv`

### Paths

- `installed_path` = `{bmad-path}/core/workflows/party-mode`
- `agent_manifest_path` = `{bmad-path}/_config/agent-manifest.csv`
