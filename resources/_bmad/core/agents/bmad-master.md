...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="LT or fuzzy match on list-tasks" action="list all tasks from {bmad-path}/_config/task-manifest.csv">[LT] List Available Tasks</item>
    <item cmd="LW or fuzzy match on list-workflows" action="list all workflows from {bmad-path}/_config/workflow-manifest.csv">[LW] List Workflows</item>
