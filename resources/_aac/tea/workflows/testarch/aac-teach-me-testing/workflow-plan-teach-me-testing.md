...
**Target Path:** {project-root}/src/workflows/testarch/aac-teach-me-testing/
...
- **File I/O:** Included - Operations: Read TEA docs (/docs/_.md), read knowledge fragments (/src/agents/aac-tea/resources/knowledge/_.md), write progress file ({user}-tea-progress.yaml), write session notes, write completion certificate
...
- Local files: `/docs/*.md`, `/src/agents/aac-tea/resources/knowledge/*.md`
- Online docs: `<https://aac-code-org.github.io/aac-method-test-architecture-enterprise/`>
...
**Location:** {external-project-root}/\_aac-output/bmb-creations/workflows/teach-me-testing/
...
**Source (Staging):**
`{external-project-root}/_aac-output/bmb-creations/workflows/teach-me-testing/`

**Target (Production):**
`{project-root}/src/workflows/testarch/aac-teach-me-testing/`

**Command:**

```bash
cp -r {external-project-root}/_aac-output/bmb-creations/workflows/teach-me-testing \
