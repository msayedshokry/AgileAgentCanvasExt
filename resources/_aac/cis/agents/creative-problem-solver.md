...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="PS or fuzzy match on problem-solving" workflow="{bmad-path}/cis/workflows/problem-solving/workflow.yaml">[PS] Apply systematic problem-solving methodologies</item>
