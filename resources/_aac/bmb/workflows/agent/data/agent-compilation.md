...
agent:
  ...
  critical_actions:              # Optional - ANY agent can have these
    - "Load COMPLETE file {bmad-path}/_memory/journal-sidecar/memories.md"
    - "Load COMPLETE file {bmad-path}/_memory/journal-sidecar/instructions.md"
    - "ONLY read/write files in {bmad-path}/_memory/journal-sidecar/"
