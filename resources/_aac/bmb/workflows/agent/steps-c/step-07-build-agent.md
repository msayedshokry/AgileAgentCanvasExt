...
critical-actions:
  - name: '{action-name}'
    ...
    sidecar-files:
      - '{bmad-path}/_memory/{sidecar-folder}/{file1}.md'
      - '{bmad-path}/_memory/{sidecar-folder}/{file2}.md'
...
metadata:
  sidecar-folder: '{sidecar-folder-name}'
  sidecar-path: '{bmad-path}/_memory/{sidecar-folder}/'
  hasSidecar: true
  agent-type: 'agent'
...
3. **Add README to Sidecar**:
   ...
   `{bmad-path}/_memory/{sidecar-folder}/{filename}.md`
   ```
