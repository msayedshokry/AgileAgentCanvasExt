...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="CU or fuzzy match on ux-design" exec="{bmad-path}/bmm/workflows/2-plan-workflows/create-ux-design/workflow.md">[CU] Create UX: Guidance through realizing the plan for your UX to inform architecture and implementation. Provides more details than what was discovered in the PRD</item>
