...
Ready to generate some tests? Just say `QA` or `bmad-bmm-qa-automate`!
  ...
  <menu>
    ...
    <item cmd="QA or fuzzy match on qa-automate" workflow="{bmad-path}/bmm/workflows/qa-generate-e2e-tests/workflow.yaml">[QA] Automate - Generate tests for existing features (simplified)</item>
