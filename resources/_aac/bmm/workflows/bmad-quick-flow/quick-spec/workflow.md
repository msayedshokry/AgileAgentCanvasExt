...
quick_dev_workflow: '{bmad-path}/bmm/workflows/bmad-quick-flow/quick-dev/workflow.md'
---
...
Read fully and follow: `{bmad-path}/bmm/workflows/bmad-quick-flow/quick-spec/steps/step-01-understand.md` to begin the workflow.
