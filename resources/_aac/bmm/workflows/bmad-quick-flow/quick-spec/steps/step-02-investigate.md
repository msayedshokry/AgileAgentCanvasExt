...
- IF C: Verify frontmatter updated with `stepsCompleted: [1, 2]`, then read fully and follow: `{bmad-path}/bmm/workflows/bmad-quick-flow/quick-spec/steps/step-03-generate.md`
