...
- **[Y] Continue existing:**
  - Jump directly to the appropriate step based on `stepsCompleted`:
    - `[1]` → Read fully and follow: `{bmad-path}/bmm/workflows/bmad-quick-flow/quick-spec/steps/step-02-investigate.md` (Step 2)
    - `[1, 2]` → Read fully and follow: `{bmad-path}/bmm/workflows/bmad-quick-flow/quick-spec/steps/step-03-generate.md` (Step 3)
    - `[1, 2, 3]` → Read fully and follow: `{bmad-path}/bmm/workflows/bmad-quick-flow/quick-spec/steps/step-04-review.md` (Step 4)
...
- IF C: Verify `{wipFile}` has `stepsCompleted: [1]`, then read fully and follow: `{bmad-path}/bmm/workflows/bmad-quick-flow/quick-spec/steps/step-02-investigate.md`
