...
- Read fully and follow: {bmad-path}/core/workflows/advanced-elicitation/workflow.xml with the current responsive/accessibility content
...
- Read fully and follow: {bmad-path}/core/workflows/party-mode/workflow.md with the current responsive/accessibility strategy
...
- Load `{bmad-path}/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-14-complete.md`
...
After user selects 'C' and content is saved to document, load `{bmad-path}/bmm/workflows/2-plan-workflows/create-ux-design/steps/step-14-complete.md` to finalize the UX design workflow.
