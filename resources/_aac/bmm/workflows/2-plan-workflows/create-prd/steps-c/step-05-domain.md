...
# File References
nextStepFile: '{bmad-path}/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-06-innovation.md'
outputFile: '{planning_artifacts}/prd.md'
domainComplexityCSV: '{bmad-path}/bmm/workflows/2-plan-workflows/create-prd/data/domain-complexity.csv'
