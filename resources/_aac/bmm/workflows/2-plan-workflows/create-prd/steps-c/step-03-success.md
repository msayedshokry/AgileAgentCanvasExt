...
# File References
nextStepFile: '{bmad-path}/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-04-journeys.md'
...
After user selects 'C' and content is saved to document, load `{bmad-path}/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-04-journeys.md` to map user journeys.
