...
# File References
nextStepFile: '{bmad-path}/bmm/workflows/2-plan-workflows/create-prd/steps-c/step-07-project-type.md'
outputFile: '{planning_artifacts}/prd.md'

# Data Files
projectTypesCSV: '{bmad-path}/bmm/workflows/2-plan-workflows/create-prd/data/project-types.csv'
