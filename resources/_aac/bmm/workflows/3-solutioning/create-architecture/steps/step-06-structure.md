...
- Read fully and follow: {bmad-path}/core/workflows/advanced-elicitation/workflow.xml with current project structure
...
- Read fully and follow: {bmad-path}/core/workflows/party-mode/workflow.md with project structure context
...
- Load `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-07-validation.md`
...
After user selects 'C' and content is saved to document, load `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-07-validation.md` to validate architectural coherence and completeness.
