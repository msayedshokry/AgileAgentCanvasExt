...
- Read fully and follow: {bmad-path}/core/workflows/advanced-elicitation/workflow.xml with validation issues
...
- Read fully and follow: {bmad-path}/core/workflows/party-mode/workflow.md with validation context
...
- Load `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-08-complete.md`
...
After user selects 'C' and content is saved to document, load `{bmad-path}/bmm/workflows/3-solutioning/create-architecture/steps/step-08-complete.md` to complete the workflow and provide implementation guidance.
