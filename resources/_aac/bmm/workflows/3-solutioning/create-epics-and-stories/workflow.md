...
Load and read full config from {bmad-path}/bmm/config.yaml and resolve:
...
Read fully and follow: `{bmad-path}/bmm/workflows/3-solutioning/create-epics-and-stories/steps/step-01-validate-prerequisites.md` to begin the workflow.
