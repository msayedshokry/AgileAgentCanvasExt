...
After user selects [C] to continue, load `{bmad-path}/bmm/workflows/generate-project-context/steps/step-02-generate.md` to collaboratively generate the specific project context rules.
