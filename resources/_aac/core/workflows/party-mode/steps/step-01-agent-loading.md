...
- Agent manifest CSV is available at `{bmad-path}/_config/agent-manifest.csv`
...
Load and parse the agent manifest CSV from `{bmad-path}/_config/agent-manifest.csv`
