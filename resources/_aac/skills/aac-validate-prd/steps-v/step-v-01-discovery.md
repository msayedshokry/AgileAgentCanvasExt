...
- IF A: Invoke the `aac-advanced-elicitation` skill, and when finished redisplay the menu
- IF P: Invoke the `aac-party-mode` skill, and when finished redisplay the menu
