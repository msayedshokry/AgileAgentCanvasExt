---
name: aac-generate-api-docs
description: 'Generate API documentation from source code analysis. Use when the user says "generate api docs" or "document the api" or "create api reference"'
---
...
1. **Determine API type** â€” Ask the user or detect from source:
   - **REST API** â€” Express, Fastify, Koa, Flask, Django, Spring, ASP.NET routes
   - **GraphQL** â€” Schema definitions, resolvers
   - **Library/SDK** â€” Exported functions, classes, interfaces
   - **CLI** â€” Commands, flags, arguments
   - **WebSocket** â€” Event handlers, message types
   - **RPC/gRPC** â€” Service definitions, proto files
...
3. **Check existing docs** â€” Look for OpenAPI/Swagger specs, JSDoc comments, docstrings, type definitions.
4. **Reference architecture** â€” If BMAD architecture artifact exists, use it for API design patterns and conventions.
...
**Rules:**
- Use real types from the codebase â€” never invent schemas
