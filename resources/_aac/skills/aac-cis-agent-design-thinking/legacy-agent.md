...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="DT or fuzzy match on design-thinking" workflow="{bmad-path}/cis/workflows/design-thinking/workflow.yaml">[DT] Guide human-centered design process</item>
