...
- When 'A' selected: Invoke the `aac-advanced-elicitation` skill
- When 'P' selected: Invoke the `aac-party-mode` skill
...
- Invoke the `aac-advanced-elicitation` skill with the current responsive/accessibility content
...
- Invoke the `aac-party-mode` skill with the current responsive/accessibility strategy
