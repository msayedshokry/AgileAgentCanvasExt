...
- Invoke the `aac-advanced-elicitation` skill with the current component strategy content
...
- Invoke the `aac-party-mode` skill with the current component strategy
