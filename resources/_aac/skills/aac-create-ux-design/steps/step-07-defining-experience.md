...
- Invoke the `aac-advanced-elicitation` skill with the current defining experience content
...
- Invoke the `aac-party-mode` skill with the current defining experience
