...
- Invoke the `aac-advanced-elicitation` skill with the current emotional response content
...
- Invoke the `aac-party-mode` skill with the current emotional response definition
