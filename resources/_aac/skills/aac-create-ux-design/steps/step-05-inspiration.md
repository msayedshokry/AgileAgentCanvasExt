...
- Invoke the `aac-advanced-elicitation` skill with the current inspiration analysis content
...
- Invoke the `aac-party-mode` skill with the current inspiration analysis
