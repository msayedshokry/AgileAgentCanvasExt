...
- Invoke the `aac-advanced-elicitation` skill with the current visual foundation content
...
- Invoke the `aac-party-mode` skill with the current visual foundation
