...
- Invoke the `aac-advanced-elicitation` skill with the current core experience content
...
- Invoke the `aac-party-mode` skill with the current core experience definition
