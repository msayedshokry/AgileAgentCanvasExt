...
<activation critical="MANDATORY">
  ...
  <menu>
    ...
    <item cmd="IS or fuzzy match on innovation-strategy" workflow="{bmad-path}/cis/workflows/innovation-strategy/workflow.yaml">[IS] Identify disruption opportunities and business model innovation</item>
