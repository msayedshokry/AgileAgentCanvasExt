...
**What:** Compare prompt file frontmatter against aac-manifest.json
...
**Implementation:** Python, reads aac-manifest.json and all prompt .md files at skill root
...
**Checks:**
```python
# Parse aac-manifest.json for external skills
