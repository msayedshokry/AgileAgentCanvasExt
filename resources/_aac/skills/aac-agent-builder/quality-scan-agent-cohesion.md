...
- `aac-manifest.json` — All capabilities with menu codes and descriptions
...
```json
{
  ...
  "findings": [
    {
      "file": "SKILL.md|aac-manifest.json|{name}.md",
...
2. Read aac-manifest.json to enumerate all capabilities
