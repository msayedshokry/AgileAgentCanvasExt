...
Before approving, you can open the spec file in an editor or ask me questions and tell me what to change. You can also use `aac-advanced-elicitation`, `aac-party-mode`, or `aac-code-review` skills, ideally in another session to avoid context bloat.
