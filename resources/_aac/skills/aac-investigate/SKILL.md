...
Present the conclusion, then a concrete next-steps menu: trivial fix → `aac-quick-dev`; scope/plan adjustment →
`aac-correct-course`; tracked story → `aac-create-story`; fresh review → `aac-code-review`. Recommend the
