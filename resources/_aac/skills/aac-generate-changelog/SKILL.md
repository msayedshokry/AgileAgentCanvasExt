---
name: aac-generate-changelog
description: 'Generate changelog or release notes from git history and project changes. Use when the user says "generate changelog" or "create release notes" or "update changelog"'
---
...
2. Check for an existing `CHANGELOG.md` â€” if present, determine whether to append or regenerate.
...
1. **Git log** â€” Parse commit messages in the specified range. Look for:
...
2. **BMAD artifacts** â€” Check sprint status, stories, and epics for completed work.
3. **Pull requests / merge commits** â€” If available, use PR titles for clearer descriptions.
...
- **Changed** â€” Changes to existing functionality (`refactor:`, `perf:`)
...
**Rules:**
- Write from the user's perspective â€” describe *what changed for them*, not implementation details
