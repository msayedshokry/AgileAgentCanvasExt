...
- `aac-manifest.json` — All capabilities with dependencies and metadata
...
1. **Parallel read batch:** Read SKILL.md, aac-manifest.json, all prompt files, and list resources/ — in a single parallel batch
...
### Scan Completeness
- Did I read SKILL.md, aac-manifest.json, and ALL prompts?
