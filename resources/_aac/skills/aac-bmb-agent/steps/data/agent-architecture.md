...
**Installation path:** `{bmad-path}/_memory/{sidecar-folder}/`

**ALL references MUST use:**
```yaml
{bmad-path}/_memory/{sidecar-folder}/{file}
```
...
# ✅ CORRECT
critical_actions:
  - "Load COMPLETE file {bmad-path}/_memory/journal-keeper-sidecar/memories.md"
  - "ONLY read/write files in {bmad-path}/_memory/journal-keeper-sidecar/"
...
```yaml
critical_actions:
  - 'Load COMPLETE file {bmad-path}/_memory/{sidecar-folder}/memories.md'
  - 'Load COMPLETE file {bmad-path}/_memory/{sidecar-folder}/instructions.md'
  - 'ONLY read/write files in {bmad-path}/_memory/{sidecar-folder}/'
```
...
menu:
  ...
  - trigger: SM or fuzzy match on save
    action: "Update {bmad-path}/_memory/{sidecar-folder}/memories.md"
...
- 'Load from {bmad-path}/_memory/{sidecar-folder}/knowledge/ but NEVER modify'
- 'Write ONLY to {bmad-path}/_memory/{sidecar-folder}/memories.md'
...
### hasSidecar: true
- [ ] ALL paths: `{bmad-path}/_memory/{sidecar-folder}/...`
