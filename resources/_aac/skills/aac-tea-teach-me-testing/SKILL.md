...
2. `{project-root}/_aac/custom/{skill-name}.toml` — team overrides
3. `{project-root}/_aac/custom/{skill-name}.user.toml` — personal overrides
...
Load config from `{project-root}/_aac/tea/config.yaml` and resolve:
