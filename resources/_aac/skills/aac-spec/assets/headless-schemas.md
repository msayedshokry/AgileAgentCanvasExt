...
```json
{
  "status": "complete",
  "files": [
    "_aac-output/specs/spec-quarter-drop/SPEC.md",
    "_aac-output/specs/spec-quarter-drop/glossary.md",
    "_aac-output/specs/spec-quarter-drop/.decision-log.md"
  ]
}
```
...
```json
{
  ...
  "reason": "Input was a one-line idea with no surrounding context; too thin to distill. Suggest aac-prd to draw the vision out first."
}
```
