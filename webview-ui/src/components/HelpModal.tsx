...
const HELP_SECTIONS: HelpSection[] = [
  ...
  },
  {
    ...
    items: [
      ...
      'Use @agileagentcanvas in chat with 30+ slash commands for AI-assisted workflows',
    ],
  },
  {
    title: 'Workflows',
    ...
    items: [
      ...
      'Use @agileagentcanvas in chat for direct interaction with the Agile Agent Canvas assistant',
