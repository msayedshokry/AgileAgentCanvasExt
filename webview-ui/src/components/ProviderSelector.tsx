...
function iconFor(id: string): JSX.Element {
    switch (id) {
        ...
        case 'pi':
            // pi-mono — uses the π (U+03C0) glyph as its brand mark.
            // No official SVG icon exists; the mathematical π rendered in
            // the provider brand colour is clean and instantly recognisable.
            return (
                <svg {...ICON_PROPS} viewBox="0 0 14 14" xmlns="http://www.w3.org/2000/svg">
                    <text
                        x="7"
