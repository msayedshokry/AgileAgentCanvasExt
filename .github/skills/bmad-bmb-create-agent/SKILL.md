...
IT IS CRITICAL THAT YOU FOLLOW THIS COMMAND: LOAD the FULL c:\Users\mohsho\.vscode\extensions\mohamed-sayed.bmad-studio-1.0.0\resources\_bmad/bmb/workflows/agent/workflow-create-agent.md, READ its entire contents and follow its directions exactly!
